function Frame() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 w-[240px] whitespace-pre-wrap">
      ...
      <p className="font-['Titillium_Web:Bold',sans-serif] leading-[1.4] relative shrink-0 text-[#f2f5f7] text-[24px] tracking-[-0.72px] w-full">Pace trend</p>
    </div>
  );
}
...
function RunningTrendsComponent() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(50%-0.4px)] rounded-[8px] top-[calc(50%-427px)] w-[851.2px]" data-name="Running trends component">
      <Frame14 />
      <Frame9 />
    </div>
  );
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 w-[240px]">
      <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] min-w-full relative shrink-0 text-[#696e70] text-[14px] tracking-[-0.42px] w-[min-content] whitespace-pre-wrap">{`Diligence `}</p>
      <p className="font-['Titillium_Web:Bold',sans-serif] leading-[1.4] relative shrink-0 text-[#f2f5f7] text-[24px] tracking-[-0.72px]">Distance trend</p>
    </div>
  );
}
...
function MiddleFrame3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="middle-frame">
      <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#989ea0] text-[14px] tracking-[-0.42px]">Pace</p>
    </div>
  );
}
...
function MiddleFrame4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="middle-frame">
      <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#060809] text-[14px] tracking-[-0.42px]">Distance</p>
    </div>
  );
}
...
function Component() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[123px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="01" />;
}

function Component1() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[83px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="02" />;
}

function Component2() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[144px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="03" />;
}

function Component3() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[123px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="04" />;
}

function Component4() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[14px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="05" />;
}

function Component5() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[168px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="06" />;
}

function Component6() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[77px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="07" />;
}

function Component7() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[14px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="08" />;
}

function Component29() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[95px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="09" />;
}

function Component30() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[77px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="10" />;
}

function Component31() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[14px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="11" />;
}

function Component32() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[95px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="12" />;
}

function Component33() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[77px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="13" />;
}

function Component34() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[14px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="14" />;
}

function Component35() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[144px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="15" />;
}

function Component36() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[77px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="16" />;
}

function Component37() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[52px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="17" />;
}

function Component38() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[106px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="18" />;
}

function Component39() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[123px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="19" />;
}

function Component40() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[83px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="20" />;
}

function Component41() {
  return <div className="bg-gradient-to-b from-[#e7a71e] h-[144px] shrink-0 to-[122.36%] to-[rgba(231,167,30,0)] w-[32px]" data-name="21" />;
}
...
function RunningTrendsComponent1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(50%-0.4px)] rounded-[8px] top-[calc(50%-36px)] w-[851.2px]" data-name="Running trends component">
      <Frame15 />
      <Frame10 />
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col items-start not-italic pb-[2px] relative shrink-0 w-[240px]">
      <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] min-w-full relative shrink-0 text-[#696e70] text-[14px] tracking-[-0.42px] w-[min-content] whitespace-pre-wrap">{`Diligence `}</p>
      <p className="font-['Titillium_Web:Bold',sans-serif] leading-[1.4] relative shrink-0 text-[#f2f5f7] text-[24px] tracking-[-0.72px]">Elevation trend</p>
    </div>
  );
}
...
function MiddleFrame8() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="middle-frame">
      <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#060809] text-[14px] tracking-[-0.42px]">Elevation</p>
    </div>
  );
}
...
function Component42() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[123px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="01" />;
}

function Component43() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[83px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="02" />;
}

function Component44() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[144px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="03" />;
}

function Component45() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[123px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="04" />;
}

function Component46() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[14px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="05" />;
}

function Component47() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[168px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="06" />;
}

function Component48() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[77px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="07" />;
}

function Component49() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[14px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="08" />;
}

function Component50() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[95px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="09" />;
}

function Component51() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[77px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="10" />;
}

function Component52() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[14px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="11" />;
}

function Component53() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[95px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="12" />;
}

function Component54() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[77px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="13" />;
}

function Component55() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[14px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="14" />;
}

function Component56() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[144px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="15" />;
}

function Component57() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[77px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="16" />;
}

function Component58() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[52px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="17" />;
}

function Component59() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[106px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="18" />;
}

function Component60() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[123px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="19" />;
}

function Component61() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[83px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="20" />;
}

function Component62() {
  return <div className="bg-gradient-to-b from-[#617bff] h-[144px] shrink-0 to-[122.36%] to-[rgba(97,123,255,0)] w-[32px]" data-name="21" />;
}
...
function RunningTrendsComponent2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[24px] items-start left-[calc(50%-0.4px)] rounded-[8px] top-[calc(50%+361px)] w-[851.2px]" data-name="Running trends component">
      <Frame16 />
      <Frame12 />
    </div>
  );
...
export default function StravaDashboardXTrendsStates() {
  return (
    <div className="bg-[#060809] relative size-full" data-name="Strava dashboard x Trends states">
