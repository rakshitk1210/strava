import svgPaths from "./svg-u52gbish29";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="trailing-icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_94_3193)" id="trailing-icon">
          <g id="vector" />
          <path d={svgPaths.p310f4100} fill="var(--fill-0, #F2F5F7)" id="vector_2" />
        </g>
        <defs>
          <clipPath id="clip0_94_3193">
    ...
    <div className="h-[50px] relative shrink-0 w-full">
      <div className="absolute inset-[-1.08%_-0.4%_0_-0.16%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212.384 50.5408">
          <g id="Group 33">
            <path d={svgPaths.pdcb6a00} fill="url(#paint0_linear_94_3197)" id="Vector 94" />
            <path d={svgPaths.p33ea1680} id="Vector 95" stroke="var(--stroke-0, #04B488)" strokeWidth="2" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_94_3197" x1="105.943" x2="105.943" y1="0.540796" y2="50.5408">
  ...
  return (
    <div className="h-[50px] relative shrink-0 w-full">
      <div className="absolute inset-[-1.08%_-0.16%_0_-0.4%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212.384 50.5408">
          <g id="Group 33">
            <path d={svgPaths.p5cebd00} fill="url(#paint0_linear_94_3183)" id="Vector 94" />
            <path d={svgPaths.p2088ab00} id="Vector 95" stroke="var(--stroke-0, #FF5E3B)" strokeWidth="2" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_94_3183" x1="106.441" x2="106.441" y1="0.540796" y2="50.5408">
  ...
  return (
    <div className="h-[50px] relative shrink-0 w-full">
      <div className="absolute inset-[-1.08%_-0.4%_0_-0.16%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212.384 50.5408">
          <g id="Group 33">
            <path d={svgPaths.pdcb6a00} fill="url(#paint0_linear_94_3189)" id="Vector 94" />
            <path d={svgPaths.p33ea1680} id="Vector 95" stroke="var(--stroke-0, #04B488)" strokeWidth="2" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_94_3189" x1="105.943" x2="105.943" y1="0.540796" y2="50.5408">
              <stop stopColor="#04B488" stopOpacity="0.3" />
              <stop offset="1" stopColor="#04B488" stopOpacity="0" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="h-[50px] relative shrink-0 w-full">
      <div className="absolute inset-[-1.08%_-0.16%_0_-0.4%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 212.384 50.5408">
          <g id="Group 34">
            <path d={svgPaths.p26cbc780} fill="url(#paint0_linear_94_3165)" id="Vector 94" />
            <path d={svgPaths.p2088ab00} id="Vector 95" stroke="var(--stroke-0, #FF5E3B)" strokeWidth="2" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_94_3165" x1="106.441" x2="106.441" y1="0.540796" y2="50.5408">
              <stop stopColor="#FC5200" stopOpacity="0.2" />
              <stop offset="1" stopColor="#FC5200" stopOpacity="0" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="max-w-[1440px] relative shrink-0 w-full">
      <div className="flex flex-row items-center max-w-[inherit] size-full">
        <div className="content-center flex flex-wrap gap-[64px] items-center max-w-[inherit] px-[64px] py-[32px] relative w-full">
          <Frame43 />
          <Frame44 />
          <Frame47 />
          <Frame51 />
...
function Frame57() {
  return (
    <div className="max-w-[1440px] relative shrink-0 w-full">
      <div className="gap-[16px] gap-[32px] grid grid-cols-[repeat(5,_minmax(0,_1fr))] grid-rows-[repeat(1,_fit-content(100%))] max-w-[inherit] px-[64px] py-[32px] relative w-full">
...
function Frame61() {
  return (
    <div className="content-center flex flex-[1_0_0] flex-wrap gap-0 items-center min-h-px min-w-px relative">
      <Component1 />
      <Component2 />
      <Component4 />
      <Component6 />
...
function Component() {
  return (
    <div className="relative shrink-0 w-full" data-name="01">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
...
function Component82() {
  return (
    <div className="relative shrink-0 w-full" data-name="03">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
...
function Component114() {
  return (
    <div className="relative shrink-0 w-full" data-name="04">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
...
function Component145() {
  return (
    <div className="relative shrink-0 w-full" data-name="05">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Mar’25 (10/31)</p>
          <Frame65 />
...
function Component177() {
  return (
    <div className="relative shrink-0 w-full" data-name="06">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Apr’25 (3/30)</p>
          <Frame67 />
...
function Component208() {
  return (
    <div className="relative shrink-0 w-full" data-name="07">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Mar’25 (10/31)</p>
          <Frame68 />
...
function Component240() {
  return (
    <div className="relative shrink-0 w-full" data-name="08">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Apr’25 (3/30)</p>
          <Frame69 />
...
function Component271() {
  return (
    <div className="relative shrink-0 w-full" data-name="09">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Mar’25 (10/31)</p>
          <Frame70 />
...
function Component303() {
  return (
    <div className="relative shrink-0 w-full" data-name="10">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Apr’25 (3/30)</p>
          <Frame71 />
...
function Component334() {
  return (
    <div className="relative shrink-0 w-full" data-name="11">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Mar’25 (10/31)</p>
          <Frame72 />
...
function Component366() {
  return (
    <div className="relative shrink-0 w-full" data-name="12">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[56px] items-center p-[24px] relative w-full">
          <p className="font-['Titillium_Web:SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#f2f5f7] text-[16px] tracking-[-0.48px] w-[140px] whitespace-pre-wrap">Apr’25 (3/30)</p>
          <Frame73 />
...
function Frame66() {
  return (
    <div className="/ 4] col-[2 content-stretch css-vsca90 flex flex-col gap-[24px] items-start relative row-[1] self-stretch shrink-0 span">
      <Frame11 />
      <Streaks />
    </div>
  );
...
function StravaDashboard() {
  return (
    <div className="bg-[#060809] h-[261px] leading-[normal] overflow-clip relative shrink-0 w-full" data-name="Strava dashboard">
      <p className="-translate-x-1/2 absolute bg-clip-text bg-gradient-to-b bottom-[218.52px] font-['Teko:SemiBold',sans-serif] font-semibold from-[#494949] from-[20.186%] left-[calc(50%-1px)] text-[140px] text-center to-[#060809] to-[66.935%] tracking-[-4.2px] translate-y-full" style={{ WebkitTextFillColor: "transparent" }}>{`RUNNING IS A PRIVILEGE `}</p>
      ...
      <p className="-translate-x-1/2 absolute bottom-[29px] font-['Titillium_Web:SemiBold',sans-serif] left-[calc(50%-0.5px)] not-italic text-[#989ea0] text-[14px] text-center tracking-[-0.42px] translate-y-full">January 2026</p>
...
export default function StravaDashboardX() {
  return (
    <div className="bg-[#060809] content-stretch flex flex-col items-center relative size-full" data-name="Strava dashboard x 1200">
      <Header />
      <Frame48 />
      <Frame59 />
      <StravaDashboard />
