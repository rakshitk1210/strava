import svgPaths from "./svg-r368io281h";
...
function Frame7() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[24px] h-[461px] items-start left-[calc(50%-0.4px)] top-1/2 w-[1043.2px]">
      <Frame />
      <Streaks />
    </div>
  );
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute h-[525px] left-1/2 top-0 w-[1440px]">
      <Frame7 />
    </div>
  );
}

export default function StravaDashboardXSection3RunningDays() {
  return (
    <div className="bg-[#060809] relative size-full" data-name="Strava dashboard x section 3 - Running days">
      <Frame1 />
    </div>
  );
}