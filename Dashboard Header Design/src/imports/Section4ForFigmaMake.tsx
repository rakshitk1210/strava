...
function Frame14() {
  return (
    <div className="absolute gap-[16px] gap-[40px] grid grid-cols-[repeat(5,_minmax(0,_1fr))] grid-rows-[repeat(1,_fit-content(100%))] left-[9px] max-w-[1440px] pb-[120px] px-[64px] top-[47px] w-[1440px]">
...
export default function Section4ForFigmaMake() {
  return (
    <div className="bg-[#060809] relative size-full" data-name="Section 4 for figma make">
      <Frame14 />
    </div>
  );
}